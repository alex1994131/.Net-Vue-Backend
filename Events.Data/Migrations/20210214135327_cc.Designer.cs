...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Events.Api.Models.General.Sector", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Events.Api.Models.General.Status", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Events.Api.Models.Incidents.Incident", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Events.Api.Models.Incidents.IncidentComment", b =>
                {
            ...
            modelBuilder.Entity("Events.Api.Models.Tasks.Task", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Events.Api.Models.APTs.AlternativeName", b =>
                {
                    ...
                    b.HasOne("Events.Api.Models.General.Status", "Status")
                        .WithMany()
            ...
            modelBuilder.Entity("Events.Api.Models.General.Organization", b =>
                {
                    b.HasOne("Events.Api.Models.General.Sector", "Sector")
            ...
            modelBuilder.Entity("Events.Api.Models.Incidents.IncidentComment", b =>
                {
                    ...
                    b.HasOne("Events.Api.Models.Incidents.Incident", "incident")
                        .WithMany("Comments")
            ...
            modelBuilder.Entity("Events.Api.Models.Incidents.IpAddress", b =>
                {
                    ...
                    b.HasOne("Events.Api.Models.Incidents.Incident", null)
            ...
            modelBuilder.Entity("Events.Api.Models.Tasks.Task", b =>
                {
                    ...
                    b.HasOne("Events.Api.Models.Incidents.Incident", "ParentIncident")
                        .WithMany()
                        .HasForeignKey("ParentIncidentId");

                    b.HasOne("Events.Api.Models.Tasks.Task", "ParentTask")
                        .WithMany()
            ...
            modelBuilder.Entity("Events.Core.Models.General.Tag", b =>
                {
                    ...
                    b.HasOne("Events.Api.Models.Tasks.Task", "task")
                        .WithMany()
            ...
            modelBuilder.Entity("Events.Core.Models.Logging.ChangeLog", b =>
                {
                    ...
                    b.HasOne("Events.Api.Models.Tasks.Task", null)
                        .WithMany("Changes")
                        .HasForeignKey("TaskId");
